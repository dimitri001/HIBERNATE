...
<head>
	...
	<title>Formaulario de Registros de Usuario</title>
...
<body>
	...
	<div class="well lead">Formaulario de Registros de Usuario</div>
 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
		...
		<c:if test="${edit}">
			<span class="well pull-left">
				<a href="<c:url value='/add-document-${user.id}' />">Click aquí para subir/manejar tus documentos</a>	
			</span>
		</c:if>
